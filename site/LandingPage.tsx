...
import appIcon from '../src/assets/azvault-icon.png';
    ...
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero">
          <div className="hero-copy">
            <div className="eyebrow">
              <span /> Azure Key Vault, without the portal maze
            </div>
            <h1>
              Your vaults.
              <br />
            ...
            <p className="hero-lede">
              A fast, open-source desktop explorer for Azure Key Vault. Browse secrets, keys, and
              certificates with the Azure CLI identity you already use.
            </p>
            ...
            <div className="platform-line">
              <span>
                <Icon name="desktop" size={15} /> macOS
              </span>
              <span>Windows</span>
              <span>Linux</span>
          ...
          <div className="hero-product">
            ...
            <aside className="safety-note">
              ...
              <div>
                ...
                <span>No refresh tokens stored.</span>
              </div>
            </aside>
          </div>
        </section>
        ...
        <section className="signal-strip" aria-label="Product principles">
          <p>
            <span>01</span> Native desktop speed
          </p>
          <p>
            <span>02</span> Azure CLI authentication
          </p>
          <p>
            <span>03</span> Built in the open
          </p>
        </section>
        ...
        <section className="product-story" id="features">
          ...
          <p className="section-intro">
            AzVault turns a multi-step cloud workflow into a quiet, focused desktop tool. No browser
            tabs. No context switching. Just the resources you came to manage.
          </p>
        ...
        <section className="security" id="security">
          ...
          <div className="security-copy">
            ...
            <p>
              ...
              short-lived access tokens. Secret values and refresh tokens are never persisted by the
              app.
            </p>
          ...
          <ul className="security-list">
            <li>
              ...
              <span>
                <strong>Short-lived access</strong>Tokens come directly from Azure CLI.
              </span>
            </li>
            <li>
              <Icon name="check" size={20} />
              <span>
                <strong>Sanitized audit trail</strong>Useful local history without secret values.
              </span>
            </li>
            <li>
              <Icon name="check" size={20} />
              <span>
                <strong>Explicit reveal</strong>Sensitive values stay hidden until requested.
              </span>
            </li>
            <li>
              <Icon name="check" size={20} />
              <span>
                <strong>Open-source core</strong>Inspect the code and threat model yourself.
              </span>
            </li>
          </ul>
        </section>
        ...
        <section className="workflow" id="workflow">
          ...
          <ol className="steps">
            ...
            <li>
              ...
              <div>
                <h3>Open AzVault</h3>
                <p>Connect with the active CLI session.</p>
              </div>
            </li>
            <li>
              <span>03</span>
              ...
              <div>
                <h3>Choose a vault</h3>
                <p>Start browsing. Nothing else to configure.</p>
              </div>
            </li>
          </ol>
        </section>
        ...
        <section className="download">
          ...
          <div>
            <p className="kicker">Open source · cross-platform</p>
            <h2>
              Your vaults are
              <br />
              ready when you are.
          ...
          <a className="button button--light" href={RELEASES}>
            <Icon name="download" size={24} /> Get AzVault
          </a>
        </section>
      </main>
      ...
      <footer>
        ...
        <div>
          <a href={`${REPOSITORY}/blob/main/PRIVACY_POLICY.md`}>Privacy</a>
